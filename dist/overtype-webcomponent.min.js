...
`)}function dt(i,e={},t={}){return{...i,colors:{...i.colors,...e},previewColors:{...i.previewColors,...t}}}function Se(i={}){let{fontSize:e="14px",lineHeight:t=1.6,fontFamily:n='"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace',padding:o="20px",theme:r=null,mobile:s={}}=i,a=Object.keys(s).length>0?`
  ...
  `:"",l=r&&r.colors?Q(r.colors,r.previewColors):"";return`
    ...
    ${a}
  `}var pe={};lt(pe,{applyCustomFormat:()=>_t,default:()=>Bi,expandSelection:()=>Et,getActiveFormats:()=>Ie,getDebugMode:()=>Ge,hasFormat:()=>Lt,insertHeader:()=>ce,insertLink:()=>Ae,preserveSelection:()=>xt,setDebugMode:()=>vt,setUndoMethod:()=>bt,toggleBold:()=>_e,toggleBulletList:()=>He,toggleCode:()=>Te,toggleH1:()=>Pe,toggleH2:()=>$e,toggleH3:()=>Re,toggleItalic:()=>Ce,toggleNumberedList:()=>Me,toggleQuote:()=>Oe,toggleTaskList:()=>le});var _i=Object.defineProperty,ht=Object.getOwnPropertySymbols,Ci=Object.prototype.hasOwnProperty,Ti=Object.prototype.propertyIsEnumerable,ut=(i,e,t)=>e in i?_i(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,ft=(i,e)=>{for(var t in e||(e={}))Ci.call(e,t)&&ut(i,t,e[t]);if(ht)for(var t of ht(e))Ti.call(e,t)&&ut(i,t,e[t]);return i},I={bold:{prefix:"**",suffix:"**",trimFirst:!0},italic:{prefix:"_",suffix:"_",trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:"[",suffix:"](url)",replaceNext:"url",scanFor:"https?://"},bulletList:{prefix:"- ",multiline:!0,unorderedList:!0},numberedList:{prefix:"1. ",multiline:!0,orderedList:!0},quote:{prefix:"> ",multiline:!0,surroundWithNewlines:!0},taskList:{prefix:"- [ ] ",multiline:!0,surroundWithNewlines:!0},header1:{prefix:"# "},header2:{prefix:"## "},header3:{prefix:"### "},header4:{prefix:"#### "},header5:{prefix:"##### "},header6:{prefix:"###### "}};function Ai(){return{prefix:"",suffix:"",blockPrefix:"",blockSuffix:"",multiline:!1,replaceNext:"",prefixSpace:!1,scanFor:"",surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function B(i){return ft(ft({},Ai()),i)}var ae=!1;function vt(i){ae=i}function Ge(){return ae}function x(i,e,t){ae&&(console.group(`\u{1F50D} ${i}`),console.log(e),t&&console.log("Data:",t),console.groupEnd())}function Le(i,e){if(!ae)return;let t=i.value.slice(i.selectionStart,i.selectionEnd);console.group(`\u{1F4CD} Selection: ${e}`),console.log("Position:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Selected text:",JSON.stringify(t)),console.log("Length:",t.length);let n=i.value.slice(Math.max(0,i.selectionStart-10),i.selectionStart),o=i.value.slice(i.selectionEnd,Math.min(i.value.length,i.selectionEnd+10));console.log("Context:",JSON.stringify(n)+"[SELECTION]"+JSON.stringify(o)),console.groupEnd()}function yt(i){ae&&(console.group("\u{1F4DD} Result"),console.log("Text to insert:",JSON.stringify(i.text)),console.log("New selection:",`${i.selectionStart}-${i.selectionEnd}`),console.groupEnd())}var A=null;function N(i,{text:e,selectionStart:t,selectionEnd:n}){let o=Ge();o&&(console.group("\u{1F527} insertText"),console.log("Current selection:",`${i.selectionStart}-${i.selectionEnd}`),console.log("Text to insert:",JSON.stringify(e)),console.log("New selection to set:",t,"-",n)),i.focus();let r=i.selectionStart,s=i.selectionEnd,a=i.value.slice(0,r),l=i.value.slice(s);o&&(console.log("Before text (last 20):",JSON.stringify(a.slice(-20))),console.log("After text (first 20):",JSON.stringify(l.slice(0,20))),console.log("Selected text being replaced:",JSON.stringify(i.value.slice(r,s))));let p=i.value,c=r!==s;if(A===null||A===!0){i.contentEditable="true";try{A=document.execCommand("insertText",!1,e),o&&console.log("execCommand returned:",A,"for text with",e.split(`
`).length,"lines")}catch(d){A=!1,o&&console.log("execCommand threw error:",d)}i.contentEditable="false"}if(o&&(console.log("canInsertText before:",A),console.log("execCommand result:",A)),A){let d=a+e+l,h=i.value;o&&(console.log("Expected length:",d.length),console.log("Actual length:",h.length)),h!==d&&o&&(console.log("execCommand changed the value but not as expected"),console.log("Expected:",JSON.stringify(d.slice(0,100))),console.log("Actual:",JSON.stringify(h.slice(0,100))))}if(!A)if(o&&console.log("Using manual insertion"),i.value===p){o&&console.log("Value unchanged, doing manual replacement");try{document.execCommand("ms-beginUndoUnit")}catch(d){}i.value=a+e+l;try{document.execCommand("ms-endUndoUnit")}catch(d){}i.dispatchEvent(new CustomEvent("input",{bubbles:!0,cancelable:!0}))}else o&&console.log("Value was changed by execCommand, skipping manual insertion");o&&console.log("Setting selection range:",t,n),t!=null&&n!=null?i.setSelectionRange(t,n):i.setSelectionRange(r,i.selectionEnd),o&&(console.log("Final value length:",i.value.length),console.groupEnd())}function bt(i){switch(i){case"native":A=!0;break;case"manual":A=!1;break;case"auto":A=null;break}}function Qe(i){return i.trim().split(`
`).length>1}function Hi(i,e){let t=e;for(;i[t]&&i[t-1]!=null&&!i[t-1].match(/\s/);)t--;return t}function Mi(i,e,t){let n=e,o=t?/\n/:/\s/;for(;i[n]&&!i[n].match(o);)n++;return n}function wt(i){let e=i.value.split(`
...
`.repeat(2-s)),{newlinesToAppend:a,newlinesToPrepend:l}}function xt(i,e){let t=i.selectionStart,n=i.selectionEnd,o=i.scrollTop;e(),i.selectionStart=t,i.selectionEnd=n,i.scrollTop=o}function Ee(i,e,t={}){let n=i.selectionStart,o=i.selectionEnd,r=n===o,s=i.value,a=n;for(;a>0&&s[a-1]!==`
`;)a--;if(r){let p=n;for(;p<s.length&&s[p]!==`
`;)p++;i.selectionStart=a,i.selectionEnd=p}else wt(i);let l=e(i);if(t.adjustSelection){let c=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix),d=t.adjustSelection(c,n,o,a);l.selectionStart=d.start,l.selectionEnd=d.end}else if(t.prefix){let c=i.value.slice(i.selectionStart,i.selectionEnd).startsWith(t.prefix);r?c?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=l.selectionStart):(l.selectionStart=n+t.prefix.length,l.selectionEnd=l.selectionStart):c?(l.selectionStart=Math.max(n-t.prefix.length,a),l.selectionEnd=Math.max(o-t.prefix.length,a)):(l.selectionStart=n+t.prefix.length,l.selectionEnd=o+t.prefix.length)}return l}function te(i,e){let t,n,{prefix:o,suffix:r,blockPrefix:s,blockSuffix:a,replaceNext:l,prefixSpace:p,scanFor:c,surroundWithNewlines:d,trimFirst:h}=e,u=i.selectionStart,f=i.selectionEnd,m=i.value.slice(i.selectionStart,i.selectionEnd),g=Qe(m)&&s&&s.length>0?`${s}
`:o,y=Qe(m)&&a&&a.length>0?`
${a}`:r;if(p){let k=i.value[i.selectionStart-1];i.selectionStart!==0&&k!=null&&!k.match(/\s/)&&(g=` ${g}`)}m=Oi(i,g,y,e.multiline);let b=i.selectionStart,w=i.selectionEnd,S=l&&l.length>0&&y.indexOf(l)>-1&&m.length>0;if(d){let k=Je(i);t=k.newlinesToAppend,n=k.newlinesToPrepend,g=t+o,y+=n}if(m.startsWith(g)&&m.endsWith(y)){let k=m.slice(g.length,m.length-y.length);if(u===f){let E=u-g.length;E=Math.max(E,b),E=Math.min(E,b+k.length),b=w=E}else w=b+k.length;return{text:k,selectionStart:b,selectionEnd:w}}else if(S)if(c&&c.length>0&&m.match(c)){y=y.replace(l,m);let k=g+y;return b=w=b+g.length,{text:k,selectionStart:b,selectionEnd:w}}else{let k=g+m+y;return b=b+g.length+m.length+y.indexOf(l),w=b+l.length,{text:k,selectionStart:b,selectionEnd:w}}else{let k=g+m+y;b=u+g.length,w=f+g.length;let E=m.match(/^\s*|\s*$/g);if(h&&E){let we=E[0]||"",Y=E[1]||"";k=we+g+m.trim()+y+Y,b+=we.length,w-=Y.length}return{text:k,selectionStart:b,selectionEnd:w}}}function Xe(i,e){let{prefix:t,suffix:n,surroundWithNewlines:o}=e,r=i.value.slice(i.selectionStart,i.selectionEnd),s=i.selectionStart,a=i.selectionEnd,l=r.split(`
...
`),o){let{newlinesToAppend:c,newlinesToPrepend:d}=Je(i);s+=c.length,a=s+r.length,r=c+r+d}return{text:r,selectionStart:s,selectionEnd:a}}function mt(i){let e=i.split(`
...
`),processed:n}}function se(i,e){return e?"- ":`${i+1}. `}function Pi(i,e){let t,n,o;return i.orderedList?(t=mt(e),n=gt(t.text),o=n.text):(t=gt(e),n=mt(t.text),o=n.text),[t,n,o]}function $i(i,e){let t=i.selectionStart===i.selectionEnd,n=i.selectionStart,o=i.selectionEnd;wt(i);let r=i.value.slice(i.selectionStart,i.selectionEnd),[s,a,l]=Pi(e,r),p=l.split(`
`).map((m,g)=>`${se(g,e.unorderedList)}${m}`),c=p.reduce((m,g,y)=>m+se(y,e.unorderedList).length,0),d=p.reduce((m,g,y)=>m+se(y,!e.unorderedList).length,0);if(s.processed)return t?(n=Math.max(n-se(0,e.unorderedList).length,0),o=n):(n=i.selectionStart,o=i.selectionEnd-c),{text:l,selectionStart:n,selectionEnd:o};let{newlinesToAppend:h,newlinesToPrepend:u}=Je(i),f=h+p.join(`
`)+u;return t?(n=Math.max(n+se(0,e.unorderedList).length+h.length,0),o=n):a.processed?(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+c-d):(n=Math.max(i.selectionStart+h.length,0),o=i.selectionEnd+h.length+c),{text:f,selectionStart:n,selectionEnd:o}}function kt(i,e){let t=Ee(i,n=>$i(n,e),{adjustSelection:(n,o,r,s)=>{let a=i.value.slice(s,i.selectionEnd),l=/^\d+\.\s+/,p=/^- /,c=l.test(a),d=p.test(a),h=e.orderedList&&c||e.unorderedList&&d;if(o===r)if(h){let u=a.match(e.orderedList?l:p),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(o-f,s)}}else if(c||d){let u=a.match(c?l:p),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:o+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:o+u}}else if(h){let u=a.match(e.orderedList?l:p),f=u?u[0].length:0;return{start:Math.max(o-f,s),end:Math.max(r-f,s)}}else if(c||d){let u=a.match(c?l:p),f=u?u[0].length:0,g=(e.unorderedList?2:3)-f;return{start:o+g,end:r+g}}else{let u=e.unorderedList?2:3;return{start:o+u,end:r+u}}}});N(i,t)}function St(i){if(!i)return[];let e=[],{selectionStart:t,selectionEnd:n,value:o}=i,r=o.split(`
`),s=0,a="";for(let d of r){if(t>=s&&t<=s+d.length){a=d;break}s+=d.length+1}a.startsWith("- ")&&(a.startsWith("- [ ] ")||a.startsWith("- [x] ")?e.push("task-list"):e.push("bullet-list")),/^\d+\.\s/.test(a)&&e.push("numbered-list"),a.startsWith("> ")&&e.push("quote"),a.startsWith("# ")&&e.push("header"),a.startsWith("## ")&&e.push("header-2"),a.startsWith("### ")&&e.push("header-3");let l=Math.max(0,t-10),p=Math.min(o.length,n+10),c=o.slice(l,p);if(c.includes("**")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("**"),f=h.indexOf("**");u!==-1&&f!==-1&&e.push("bold")}if(c.includes("_")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("_"),f=h.indexOf("_");u!==-1&&f!==-1&&e.push("italic")}if(c.includes("`")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100));d.includes("`")&&h.includes("`")&&e.push("code")}if(c.includes("[")&&c.includes("]")){let d=o.slice(Math.max(0,t-100),t),h=o.slice(n,Math.min(o.length,n+100)),u=d.lastIndexOf("["),f=h.indexOf("]");u!==-1&&f!==-1&&o.slice(n+f+1,n+f+10).startsWith("(")&&e.push("link")}return e}function Ri(i,e){return St(i).includes(e)}function Ii(i,e={}){if(!i)return;let{toWord:t,toLine:n,toFormat:o}=e,{selectionStart:r,selectionEnd:s,value:a}=i;if(n){let l=a.split(`
`),p=0,c=0,d=0;for(let h of l){if(r>=d&&r<=d+h.length){p=d,c=d+h.length;break}d+=h.length+1}i.selectionStart=p,i.selectionEnd=c}else if(t&&r===s){let l=r,p=s;for(;l>0&&!/\s/.test(a[l-1]);)l--;for(;p<a.length&&!/\s/.test(a[p]);)p++;i.selectionStart=l,i.selectionEnd=p}}function _e(i){if(!i||i.disabled||i.readOnly)return;x("toggleBold","Starting"),Le(i,"Before");let e=B(I.bold),t=te(i,e);yt(t),N(i,t),Le(i,"After")}function Ce(i){if(!i||i.disabled||i.readOnly)return;let e=B(I.italic),t=te(i,e);N(i,t)}function Te(i){if(!i||i.disabled||i.readOnly)return;let e=B(I.code),t=te(i,e);N(i,t)}function Ae(i,e={}){if(!i||i.disabled||i.readOnly)return;let t=i.value.slice(i.selectionStart,i.selectionEnd),n=B(I.link);if(t&&t.match(/^https?:\/\//)&&!e.url?(n.suffix=`](${t})`,n.replaceNext=""):e.url&&(n.suffix=`](${e.url})`,n.replaceNext=""),e.text&&!t){let s=i.selectionStart;i.value=i.value.slice(0,s)+e.text+i.value.slice(s),i.selectionStart=s,i.selectionEnd=s+e.text.length}let r=te(i,n);N(i,r)}function He(i){if(!i||i.disabled||i.readOnly)return;let e=B(I.bulletList);kt(i,e)}function Me(i){if(!i||i.disabled||i.readOnly)return;let e=B(I.numberedList);kt(i,e)}function Oe(i){if(!i||i.disabled||i.readOnly)return;x("toggleQuote","Starting"),Le(i,"Initial");let e=B(I.quote),t=Ee(i,n=>Xe(n,e),{prefix:e.prefix});yt(t),N(i,t),Le(i,"Final")}function le(i){if(!i||i.disabled||i.readOnly)return;let e=B(I.taskList),t=Ee(i,n=>Xe(n,e),{prefix:e.prefix});N(i,t)}function ce(i,e=1,t=!1){if(!i||i.disabled||i.readOnly)return;(e<1||e>6)&&(e=1),x("insertHeader","============ START ============"),x("insertHeader",`Level: ${e}, Toggle: ${t}`),x("insertHeader",`Initial cursor: ${i.selectionStart}-${i.selectionEnd}`);let n=`header${e===1?"1":e}`,o=B(I[n]||I.header1);x("insertHeader",`Style prefix: "${o.prefix}"`);let r=i.value,s=i.selectionStart,a=i.selectionEnd,l=s;for(;l>0&&r[l-1]!==`
`;)l--;let p=a;for(;p<r.length&&r[p]!==`
`;)p++;let c=r.slice(l,p);x("insertHeader",`Current line (before): "${c}"`);let d=c.match(/^(#{1,6})\s*/),h=d?d[1].length:0,u=d?d[0].length:0;x("insertHeader","Existing header check:"),x("insertHeader",`  - Match: ${d?`"${d[0]}"`:"none"}`),x("insertHeader",`  - Existing level: ${h}`),x("insertHeader",`  - Existing prefix length: ${u}`),x("insertHeader",`  - Target level: ${e}`);let f=t&&h===e;x("insertHeader",`Should toggle OFF: ${f} (toggle=${t}, existingLevel=${h}, level=${e})`);let m=Ee(i,g=>{let y=g.value.slice(g.selectionStart,g.selectionEnd);x("insertHeader",`Line in operation: "${y}"`);let b=y.replace(/^#{1,6}\s*/,"");x("insertHeader",`Cleaned line: "${b}"`);let w;return f?(x("insertHeader","ACTION: Toggling OFF - removing header"),w=b):h>0?(x("insertHeader",`ACTION: Replacing H${h} with H${e}`),w=o.prefix+b):(x("insertHeader","ACTION: Adding new header"),w=o.prefix+b),x("insertHeader",`New line: "${w}"`),{text:w,selectionStart:g.selectionStart,selectionEnd:g.selectionEnd}},{prefix:o.prefix,adjustSelection:(g,y,b,w)=>{if(x("insertHeader","Adjusting selection:"),x("insertHeader",`  - isRemoving param: ${g}`),x("insertHeader",`  - shouldToggleOff: ${f}`),x("insertHeader",`  - selStart: ${y}, selEnd: ${b}`),x("insertHeader",`  - lineStartPos: ${w}`),f){let S=Math.max(y-u,w);return x("insertHeader",`  - Removing header, adjusting by -${u}`),{start:S,end:y===b?S:Math.max(b-u,w)}}else if(u>0){let S=o.prefix.length-u;return x("insertHeader",`  - Replacing header, adjusting by ${S}`),{start:y+S,end:b+S}}else return x("insertHeader",`  - Adding header, adjusting by +${o.prefix.length}`),{start:y+o.prefix.length,end:b+o.prefix.length}}});x("insertHeader",`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),x("insertHeader","============ END ============"),N(i,m)}function Pe(i){ce(i,1,!0)}function $e(i){ce(i,2,!0)}function Re(i){ce(i,3,!0)}function Ie(i){return St(i)}function Lt(i,e){return Ri(i,e)}function Et(i,e={}){Ii(i,e)}function _t(i,e){if(!i||i.disabled||i.readOnly)return;let t=B(e),n;if(t.multiline){let o=i.value.slice(i.selectionStart,i.selectionEnd);Qe(o)?n=Xe(i,t):n=te(i,t)}else n=te(i,t);N(i,n)}var Bi={toggleBold:_e,toggleItalic:Ce,toggleCode:Te,insertLink:Ae,toggleBulletList:He,toggleNumberedList:Me,toggleQuote:Oe,toggleTaskList:le,insertHeader:ce,toggleH1:Pe,toggleH2:$e,toggleH3:Re,getActiveFormats:Ie,hasFormat:Lt,expandSelection:Et,applyCustomFormat:_t,preserveSelection:xt,setUndoMethod:bt,setDebugMode:vt,getDebugMode:Ge};var Be=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement("div"),this.container.className="overtype-toolbar",this.container.setAttribute("role","toolbar"),this.container.setAttribute("aria-label","Formatting toolbar"),this.toolbarButtons.forEach(e=>{if(e.name==="separator"){let t=this.createSeparator();this.container.appendChild(t)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement("div");return e.className="overtype-toolbar-separator",e.setAttribute("role","separator"),e}createButton(e){let t=document.createElement("button");return t.className="overtype-toolbar-button",t.type="button",t.setAttribute("data-button",e.name),t.title=e.title||"",t.setAttribute("aria-label",e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||""),e.name==="viewMode"?(t.classList.add("has-dropdown"),t.dataset.dropdown="true",t.addEventListener("click",n=>{n.preventDefault(),this.toggleViewModeDropdown(t)}),t):(t._clickHandler=n=>{n.preventDefault();let o=e.actionId||e.name;this.editor.performAction(o,n)},t.addEventListener("click",t._clickHandler),t)}async handleAction(e){if(e&&typeof e=="object"&&typeof e.action=="function"){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:t=>this.editor.setValue(t),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent("button-error",{detail:{buttonName:e.name,error:t}})),!1}}return typeof e=="string"?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e!="string"?"":e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/\son\w+\s*=\s*["'][^"']*["']/gi,"").replace(/\son\w+\s*=\s*[^\s>]*/gi,"")}toggleViewModeDropdown(e){let t=document.querySelector(".overtype-dropdown-menu");if(t){t.remove(),e.classList.remove("dropdown-active");return}e.classList.add("dropdown-active");let n=this.createViewModeDropdown(e),o=e.getBoundingClientRect();n.style.position="absolute",n.style.top=`${o.bottom+5}px`,n.style.left=`${o.left}px`,document.body.appendChild(n),this.handleDocumentClick=r=>{!n.contains(r.target)&&!e.contains(r.target)&&(n.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick))},setTimeout(()=>{document.addEventListener("click",this.handleDocumentClick)},0)}createViewModeDropdown(e){let t=document.createElement("div");t.className="overtype-dropdown-menu";let n=[{id:"normal",label:"Normal Edit",icon:"\u2713"},{id:"plain",label:"Plain Textarea",icon:"\u2713"},{id:"preview",label:"Preview Mode",icon:"\u2713"}],o=this.editor.container.dataset.mode||"normal";return n.forEach(r=>{let s=document.createElement("button");if(s.className="overtype-dropdown-item",s.type="button",s.textContent=r.label,r.id===o){s.classList.add("active"),s.setAttribute("aria-current","true");let a=document.createElement("span");a.className="overtype-dropdown-icon",a.textContent=r.icon,s.prepend(a)}s.addEventListener("click",a=>{switch(a.preventDefault(),r.id){case"plain":this.editor.showPlainTextarea();break;case"preview":this.editor.showPreviewMode();break;case"normal":default:this.editor.showNormalEditMode();break}t.remove(),e.classList.remove("dropdown-active"),document.removeEventListener("click",this.handleDocumentClick)}),t.appendChild(s)}),t}updateButtonStates(){var e;try{let t=((e=Ie)==null?void 0:e(this.editor.textarea,this.editor.textarea.selectionStart))||[];Object.entries(this.buttons).forEach(([n,o])=>{if(n==="viewMode")return;let r=!1;switch(n){case"bold":r=t.includes("bold");break;case"italic":r=t.includes("italic");break;case"code":r=!1;break;case"bulletList":r=t.includes("bullet-list");break;case"orderedList":r=t.includes("numbered-list");break;case"taskList":r=t.includes("task-list");break;case"quote":r=t.includes("quote");break;case"h1":r=t.includes("header");break;case"h2":r=t.includes("header-2");break;case"h3":r=t.includes("header-3");break}o.classList.toggle("active",r),o.setAttribute("aria-pressed",r.toString())})}catch(t){}}show(){this.container&&this.container.classList.remove("overtype-toolbar-hidden")}hide(){this.container&&this.container.classList.add("overtype-toolbar-hidden")}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener("click",this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener("click",e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}};var he=Math.min,U=Math.max,ue=Math.round;var P=i=>({x:i,y:i}),zi={left:"right",right:"left",bottom:"top",top:"bottom"},Fi={start:"end",end:"start"};function Ye(i,e,t){return U(i,he(e,t))}function fe(i,e){return typeof i=="function"?i(e):i}function W(i){return i.split("-")[0]}function me(i){return i.split("-")[1]}function et(i){return i==="x"?"y":"x"}function tt(i){return i==="y"?"height":"width"}var Ni=new Set(["top","bottom"]);function D(i){return Ni.has(W(i))?"y":"x"}function it(i){return et(D(i))}function At(i,e,t){t===void 0&&(t=!1);let n=me(i),o=it(i),r=tt(o),s=o==="x"?n===(t?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(s=de(s)),[s,de(s)]}function Ht(i){let e=de(i);return[ze(i),e,ze(e)]}function ze(i){return i.replace(/start|end/g,e=>Fi[e])}var Ct=["left","right"],Tt=["right","left"],Di=["top","bottom"],Vi=["bottom","top"];function ji(i,e,t){switch(i){case"top":case"bottom":return t?e?Tt:Ct:e?Ct:Tt;case"left":case"right":return e?Di:Vi;default:return[]}}function Mt(i,e,t,n){let o=me(i),r=ji(W(i),t==="start",n);return o&&(r=r.map(s=>s+"-"+o),e&&(r=r.concat(r.map(ze)))),r}function de(i){return i.replace(/left|right|bottom|top/g,e=>zi[e])}function Ui(i){return{top:0,right:0,bottom:0,left:0,...i}}function Ot(i){return typeof i!="number"?Ui(i):{top:i,right:i,bottom:i,left:i}}function G(i){let{x:e,y:t,width:n,height:o}=i;return{width:n,height:o,top:t,left:e,right:e+n,bottom:t+o,x:e,y:t}}function Pt(i,e,t){let{reference:n,floating:o}=i,r=D(e),s=it(e),a=tt(s),l=W(e),p=r==="y",c=n.x+n.width/2-o.width/2,d=n.y+n.height/2-o.height/2,h=n[a]/2-o[a]/2,u;switch(l){case"top":u={x:c,y:n.y-o.height};break;case"bottom":u={x:c,y:n.y+n.height};break;case"right":u={x:n.x+n.width,y:d};break;case"left":u={x:n.x-o.width,y:d};break;default:u={x:n.x,y:n.y}}switch(me(e)){case"start":u[s]-=h*(t&&p?-1:1);break;case"end":u[s]+=h*(t&&p?-1:1);break}return u}async function $t(i,e){var t;e===void 0&&(e={});let{x:n,y:o,platform:r,rects:s,elements:a,strategy:l}=i,{boundary:p="clippingAncestors",rootBoundary:c="viewport",elementContext:d="floating",altBoundary:h=!1,padding:u=0}=fe(e,i),f=Ot(u),g=a[h?d==="floating"?"reference":"floating":d],y=G(await r.getClippingRect({element:(t=await(r.isElement==null?void 0:r.isElement(g)))==null||t?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:p,rootBoundary:c,strategy:l})),b=d==="floating"?{x:n,y:o,width:s.floating.width,height:s.floating.height}:s.reference,w=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),S=await(r.isElement==null?void 0:r.isElement(w))?await(r.getScale==null?void 0:r.getScale(w))||{x:1,y:1}:{x:1,y:1},k=G(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:b,offsetParent:w,strategy:l}):b);return{top:(y.top-k.top+f.top)/S.y,bottom:(k.bottom-y.bottom+f.bottom)/S.y,left:(y.left-k.left+f.left)/S.x,right:(k.right-y.right+f.right)/S.x}}var Rt=async(i,e,t)=>{let{placement:n="bottom",strategy:o="absolute",middleware:r=[],platform:s}=t,a=r.filter(Boolean),l=await(s.isRTL==null?void 0:s.isRTL(e)),p=await s.getElementRects({reference:i,floating:e,strategy:o}),{x:c,y:d}=Pt(p,n,l),h=n,u={},f=0;for(let g=0;g<a.length;g++){var m;let{name:y,fn:b}=a[g],{x:w,y:S,data:k,reset:E}=await b({x:c,y:d,initialPlacement:n,placement:h,strategy:o,middlewareData:u,rects:p,platform:{...s,detectOverflow:(m=s.detectOverflow)!=null?m:$t},elements:{reference:i,floating:e}});c=w!=null?w:c,d=S!=null?S:d,u={...u,[y]:{...u[y],...k}},E&&f<=50&&(f++,typeof E=="object"&&(E.placement&&(h=E.placement),E.rects&&(p=E.rects===!0?await s.getElementRects({reference:i,floating:e,strategy:o}):E.rects),{x:c,y:d}=Pt(p,h,l)),g=-1)}return{x:c,y:d,placement:h,strategy:o,middlewareData:u}};var It=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(e){var t,n;let{placement:o,middlewareData:r,rects:s,initialPlacement:a,platform:l,elements:p}=e,{mainAxis:c=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=fe(i,e);if((t=r.arrow)!=null&&t.alignmentOffset)return{};let y=W(o),b=D(a),w=W(a)===a,S=await(l.isRTL==null?void 0:l.isRTL(p.floating)),k=h||(w||!m?[de(a)]:Ht(a)),E=f!=="none";!h&&E&&k.push(...Mt(a,m,f,S));let we=[a,...k],Y=await l.detectOverflow(e,g),xe=[],ee=((n=r.flip)==null?void 0:n.overflows)||[];if(c&&xe.push(Y[y]),d){let K=At(o,s,S);xe.push(Y[K[0]],Y[K[1]])}if(ee=[...ee,{placement:o,overflows:xe}],!xe.every(K=>K<=0)){var rt,st;let K=(((rt=r.flip)==null?void 0:rt.index)||0)+1,Ke=we[K];if(Ke&&(!(d==="alignment"?b!==D(Ke):!1)||ee.every(O=>D(O.placement)===b?O.overflows[0]>0:!0)))return{data:{index:K,overflows:ee},reset:{placement:Ke}};let oe=(st=ee.filter(Z=>Z.overflows[0]<=0).sort((Z,O)=>Z.overflows[1]-O.overflows[1])[0])==null?void 0:st.placement;if(!oe)switch(u){case"bestFit":{var at;let Z=(at=ee.filter(O=>{if(E){let j=D(O.placement);return j===b||j==="y"}return!0}).map(O=>[O.placement,O.overflows.filter(j=>j>0).reduce((j,bi)=>j+bi,0)]).sort((O,j)=>O[1]-j[1])[0])==null?void 0:at[0];Z&&(oe=Z);break}case"initialPlacement":oe=a;break}if(o!==oe)return{reset:{placement:oe}}}return{}}}};var Wi=new Set(["left","top"]);async function qi(i,e){let{placement:t,platform:n,elements:o}=i,r=await(n.isRTL==null?void 0:n.isRTL(o.floating)),s=W(t),a=me(t),l=D(t)==="y",p=Wi.has(s)?-1:1,c=r&&l?-1:1,d=fe(e,i),{mainAxis:h,crossAxis:u,alignmentAxis:f}=typeof d=="number"?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return a&&typeof f=="number"&&(u=a==="end"?f*-1:f),l?{x:u*c,y:h*p}:{x:h*p,y:u*c}}var Bt=function(i){return i===void 0&&(i=0),{name:"offset",options:i,async fn(e){var t,n;let{x:o,y:r,placement:s,middlewareData:a}=e,l=await qi(e,i);return s===((t=a.offset)==null?void 0:t.placement)&&(n=a.arrow)!=null&&n.alignmentOffset?{}:{x:o+l.x,y:r+l.y,data:{...l,placement:s}}}}},zt=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(e){let{x:t,y:n,placement:o,platform:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:y=>{let{x:b,y:w}=y;return{x:b,y:w}}},...p}=fe(i,e),c={x:t,y:n},d=await r.detectOverflow(e,p),h=D(W(o)),u=et(h),f=c[u],m=c[h];if(s){let y=u==="y"?"top":"left",b=u==="y"?"bottom":"right",w=f+d[y],S=f-d[b];f=Ye(w,f,S)}if(a){let y=h==="y"?"top":"left",b=h==="y"?"bottom":"right",w=m+d[y],S=m-d[b];m=Ye(w,m,S)}let g=l.fn({...e,[u]:f,[h]:m});return{...g,data:{x:g.x-t,y:g.y-n,enabled:{[u]:s,[h]:a}}}}}};function Ne(){return typeof window<"u"}function J(i){return Nt(i)?(i.nodeName||"").toLowerCase():"#document"}function T(i){var e;return(i==null||(e=i.ownerDocument)==null?void 0:e.defaultView)||window}function z(i){var e;return(e=(Nt(i)?i.ownerDocument:i.document)||window.document)==null?void 0:e.documentElement}function Nt(i){return Ne()?i instanceof Node||i instanceof T(i).Node:!1}function H(i){return Ne()?i instanceof Element||i instanceof T(i).Element:!1}function $(i){return Ne()?i instanceof HTMLElement||i instanceof T(i).HTMLElement:!1}function Ft(i){return!Ne()||typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof T(i).ShadowRoot}var Ki=new Set(["inline","contents"]);function ie(i){let{overflow:e,overflowX:t,overflowY:n,display:o}=M(i);return/auto|scroll|overlay|hidden|clip/.test(e+n+t)&&!Ki.has(o)}var Zi=new Set(["table","td","th"]);function Dt(i){return Zi.has(J(i))}var Qi=[":popover-open",":modal"];function ge(i){return Qi.some(e=>{try{return i.matches(e)}catch(t){return!1}})}var Gi=["transform","translate","scale","rotate","perspective"],Ji=["transform","translate","scale","rotate","perspective","filter"],Xi=["paint","layout","strict","content"];function De(i){let e=Ve(),t=H(i)?M(i):i;return Gi.some(n=>t[n]?t[n]!=="none":!1)||(t.containerType?t.containerType!=="normal":!1)||!e&&(t.backdropFilter?t.backdropFilter!=="none":!1)||!e&&(t.filter?t.filter!=="none":!1)||Ji.some(n=>(t.willChange||"").includes(n))||Xi.some(n=>(t.contain||"").includes(n))}function Vt(i){let e=V(i);for(;$(e)&&!X(e);){if(De(e))return e;if(ge(e))return null;e=V(e)}return null}function Ve(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var Yi=new Set(["html","body","#document"]);function X(i){return Yi.has(J(i))}function M(i){return T(i).getComputedStyle(i)}function ve(i){return H(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function V(i){if(J(i)==="html")return i;let e=i.assignedSlot||i.parentNode||Ft(i)&&i.host||z(i);return Ft(e)?e.host:e}function jt(i){let e=V(i);return X(e)?i.ownerDocument?i.ownerDocument.body:i.body:$(e)&&ie(e)?e:jt(e)}function Fe(i,e,t){var n;e===void 0&&(e=[]),t===void 0&&(t=!0);let o=jt(i),r=o===((n=i.ownerDocument)==null?void 0:n.body),s=T(o);if(r){let a=je(s);return e.concat(s,s.visualViewport||[],ie(o)?o:[],a&&t?Fe(a):[])}return e.concat(o,Fe(o,[],t))}function je(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function Kt(i){let e=M(i),t=parseFloat(e.width)||0,n=parseFloat(e.height)||0,o=$(i),r=o?i.offsetWidth:t,s=o?i.offsetHeight:n,a=ue(t)!==r||ue(n)!==s;return a&&(t=r,n=s),{width:t,height:n,$:a}}function Zt(i){return H(i)?i:i.contextElement}function ne(i){let e=Zt(i);if(!$(e))return P(1);let t=e.getBoundingClientRect(),{width:n,height:o,$:r}=Kt(e),s=(r?ue(t.width):t.width)/n,a=(r?ue(t.height):t.height)/o;return(!s||!Number.isFinite(s))&&(s=1),(!a||!Number.isFinite(a))&&(a=1),{x:s,y:a}}var en=P(0);function Qt(i){let e=T(i);return!Ve()||!e.visualViewport?en:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function tn(i,e,t){return e===void 0&&(e=!1),!t||e&&t!==T(i)?!1:e}function ye(i,e,t,n){e===void 0&&(e=!1),t===void 0&&(t=!1);let o=i.getBoundingClientRect(),r=Zt(i),s=P(1);e&&(n?H(n)&&(s=ne(n)):s=ne(i));let a=tn(r,t,n)?Qt(r):P(0),l=(o.left+a.x)/s.x,p=(o.top+a.y)/s.y,c=o.width/s.x,d=o.height/s.y;if(r){let h=T(r),u=n&&H(n)?T(n):n,f=h,m=je(f);for(;m&&n&&u!==f;){let g=ne(m),y=m.getBoundingClientRect(),b=M(m),w=y.left+(m.clientLeft+parseFloat(b.paddingLeft))*g.x,S=y.top+(m.clientTop+parseFloat(b.paddingTop))*g.y;l*=g.x,p*=g.y,c*=g.x,d*=g.y,l+=w,p+=S,f=T(m),m=je(f)}}return G({width:c,height:d,x:l,y:p})}function Ue(i,e){let t=ve(i).scrollLeft;return e?e.left+t:ye(z(i)).left+t}function Gt(i,e){let t=i.getBoundingClientRect(),n=t.left+e.scrollLeft-Ue(i,t),o=t.top+e.scrollTop;return{x:n,y:o}}function nn(i){let{elements:e,rect:t,offsetParent:n,strategy:o}=i,r=o==="fixed",s=z(n),a=e?ge(e.floating):!1;if(n===s||a&&r)return t;let l={scrollLeft:0,scrollTop:0},p=P(1),c=P(0),d=$(n);if((d||!d&&!r)&&((J(n)!=="body"||ie(s))&&(l=ve(n)),$(n))){let u=ye(n);p=ne(n),c.x=u.x+n.clientLeft,c.y=u.y+n.clientTop}let h=s&&!d&&!r?Gt(s,l):P(0);return{width:t.width*p.x,height:t.height*p.y,x:t.x*p.x-l.scrollLeft*p.x+c.x+h.x,y:t.y*p.y-l.scrollTop*p.y+c.y+h.y}}function on(i){return Array.from(i.getClientRects())}function rn(i){let e=z(i),t=ve(i),n=i.ownerDocument.body,o=U(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=U(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),s=-t.scrollLeft+Ue(i),a=-t.scrollTop;return M(n).direction==="rtl"&&(s+=U(e.clientWidth,n.clientWidth)-o),{width:o,height:r,x:s,y:a}}var Ut=25;function sn(i,e){let t=T(i),n=z(i),o=t.visualViewport,r=n.clientWidth,s=n.clientHeight,a=0,l=0;if(o){r=o.width,s=o.height;let c=Ve();(!c||c&&e==="fixed")&&(a=o.offsetLeft,l=o.offsetTop)}let p=Ue(n);if(p<=0){let c=n.ownerDocument,d=c.body,h=getComputedStyle(d),u=c.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,f=Math.abs(n.clientWidth-d.clientWidth-u);f<=Ut&&(r-=f)}else p<=Ut&&(r+=p);return{width:r,height:s,x:a,y:l}}var an=new Set(["absolute","fixed"]);function ln(i,e){let t=ye(i,!0,e==="fixed"),n=t.top+i.clientTop,o=t.left+i.clientLeft,r=$(i)?ne(i):P(1),s=i.clientWidth*r.x,a=i.clientHeight*r.y,l=o*r.x,p=n*r.y;return{width:s,height:a,x:l,y:p}}function Wt(i,e,t){let n;if(e==="viewport")n=sn(i,t);else if(e==="document")n=rn(z(i));else if(H(e))n=ln(e,t);else{let o=Qt(i);n={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return G(n)}function Jt(i,e){let t=V(i);return t===e||!H(t)||X(t)?!1:M(t).position==="fixed"||Jt(t,e)}function cn(i,e){let t=e.get(i);if(t)return t;let n=Fe(i,[],!1).filter(a=>H(a)&&J(a)!=="body"),o=null,r=M(i).position==="fixed",s=r?V(i):i;for(;H(s)&&!X(s);){let a=M(s),l=De(s);!l&&a.position==="fixed"&&(o=null),(r?!l&&!o:!l&&a.position==="static"&&!!o&&an.has(o.position)||ie(s)&&!l&&Jt(i,s))?n=n.filter(c=>c!==s):o=a,s=V(s)}return e.set(i,n),n}function pn(i){let{element:e,boundary:t,rootBoundary:n,strategy:o}=i,s=[...t==="clippingAncestors"?ge(e)?[]:cn(e,this._c):[].concat(t),n],a=s[0],l=s.reduce((p,c)=>{let d=Wt(e,c,o);return p.top=U(d.top,p.top),p.right=he(d.right,p.right),p.bottom=he(d.bottom,p.bottom),p.left=U(d.left,p.left),p},Wt(e,a,o));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function dn(i){let{width:e,height:t}=Kt(i);return{width:e,height:t}}function hn(i,e,t){let n=$(e),o=z(e),r=t==="fixed",s=ye(i,!0,r,e),a={scrollLeft:0,scrollTop:0},l=P(0);function p(){l.x=Ue(o)}if(n||!n&&!r)if((J(e)!=="body"||ie(o))&&(a=ve(e)),n){let u=ye(e,!0,r,e);l.x=u.x+e.clientLeft,l.y=u.y+e.clientTop}else o&&p();r&&!n&&o&&p();let c=o&&!n&&!r?Gt(o,a):P(0),d=s.left+a.scrollLeft-l.x-c.x,h=s.top+a.scrollTop-l.y-c.y;return{x:d,y:h,width:s.width,height:s.height}}function nt(i){return M(i).position==="static"}function qt(i,e){if(!$(i)||M(i).position==="fixed")return null;if(e)return e(i);let t=i.offsetParent;return z(i)===t&&(t=t.ownerDocument.body),t}function Xt(i,e){let t=T(i);if(ge(i))return t;if(!$(i)){let o=V(i);for(;o&&!X(o);){if(H(o)&&!nt(o))return o;o=V(o)}return t}let n=qt(i,e);for(;n&&Dt(n)&&nt(n);)n=qt(n,e);return n&&X(n)&&nt(n)&&!De(n)?t:n||Vt(i)||t}var un=async function(i){let e=this.getOffsetParent||Xt,t=this.getDimensions,n=await t(i.floating);return{reference:hn(i.reference,await e(i.floating),i.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function fn(i){return M(i).direction==="rtl"}var mn={convertOffsetParentRelativeRectToViewportRelativeRect:nn,getDocumentElement:z,getClippingRect:pn,getOffsetParent:Xt,getElementRects:un,getClientRects:on,getDimensions:dn,getScale:ne,isElement:H,isRTL:fn};var Yt=Bt;var ei=zt,ti=It;var ii=(i,e,t)=>{let n=new Map,o={platform:mn,...t},r={...o.platform,_c:n};return Rt(i,e,{...o,platform:r})};var We=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener("selectionchange",()=>this.checkCursorPosition()),this.editor.textarea.addEventListener("keyup",e=>{(e.key.includes("Arrow")||e.key==="Home"||e.key==="End")&&this.checkCursorPosition()}),this.editor.textarea.addEventListener("input",()=>this.hide()),this.editor.textarea.addEventListener("scroll",()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener("blur",()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener("visibilitychange",this.visibilityChangeHandler),this.tooltip.addEventListener("mouseenter",()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener("mouseleave",()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement("div"),this.tooltip.className="overtype-link-tooltip",this.tooltip.innerHTML=`
...
`),l=a.length,p=a[a.length-1].length+1;return{characters:n,words:o,lines:t.length,line:l,column:p}}isReady(){return this._initialized&&this._editor!==null}getEditor(){return this._editor}showToolbar(){this._editor&&this._editor.showToolbar()}hideToolbar(){this._editor&&this._editor.hideToolbar()}};customElements.get("overtype-editor")||customElements.define("overtype-editor",qe);var wn=qe;return Ei(xn);})();
/**
